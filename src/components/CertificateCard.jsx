  ...
  return (
    <Card as="article" padded={false} className="group flex h-full flex-col overflow-hidden">
      <ImagePlaceholder
        ...
        className="aspect-4/3 w-full border-x-0 border-t-0 border-b border-solid border-secondary/8"
      />
      ...
      <div className="flex flex-1 flex-col gap-1.5 p-6 sm:p-7">
        ...
        <p className="mt-auto pt-2 text-sm text-dim">{certificate.date}</p>
      </div>
    </Card>
  );
}
